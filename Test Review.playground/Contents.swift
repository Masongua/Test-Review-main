...
var BMI = findBMI(Weight: 203.4, Height: 66)
print(BMI)
 ...
 */
// Write your code below 💪
var NWH = ["Peter Parker": "Tom Holand", "MJ": "Zendaya", "Norman Osborn": "Willem Dafoe"]
NWH.removeValue(forKey: "Peter Parker")
NWH["Doctor Strange"] = "Benedict Cumberbatch"
NWH.updateValue("Zendaya Maree Stoermer Coleman", forKey: "Mj")
for (charact, act) in NWH{
    print("\(charact) is played by \(act)")
}
